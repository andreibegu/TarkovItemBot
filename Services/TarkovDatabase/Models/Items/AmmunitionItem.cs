...
namespace TarkovItemBot.Services
{
    public class AmmunitionItem : BaseItem
    {
        ...
        public override EmbedBuilder ToEmbedBuilder()
        {
            ...
            if (WeaponModifier.Accuracy != 0) builder.AddField("Accuracy", WeaponModifier.Accuracy, true);
            if (WeaponModifier.Recoil != 0) builder.AddField("Recoil", WeaponModifier.Recoil, true);
